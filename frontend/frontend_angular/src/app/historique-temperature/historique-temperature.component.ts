...
@Component({
  selector: 'app-historique-temperature',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './historique-temperature.component.html',
  styleUrls: ['./historique-temperature.component.css']
})
export class HistoriqueTemperatureComponent {
...
ngOnInit(): void {
  ...
  console.log("🧪 sensorId reçu :", this.sensorId);
